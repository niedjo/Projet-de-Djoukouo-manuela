...
if (isset($_POST['annuler'])) {
    ...
    $sql ="INSERT INTO `utilisateur`(`nom_et_prenom`, `mot_de_passe`, `age`, `sexe`, `status_user`) 
    VALUES (:nom_et_prenom, :mot_de_passe, :age, :sexe, :status_user);";
...
<body>
    ...
    <center>
        <h3 style="color: red;">Ajouter un Utilisateur</h3>
        <div class="container">
